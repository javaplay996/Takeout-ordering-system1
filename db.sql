...
MySQL - 5.7.32-log : Database - waimiadiancan
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`waimiadiancan` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `caipin`(`id`,`hx_types`,`money`,`img_photo`,`caipin_content`,`clicknum`) values (1,3,'30.00','http://localhost:8080/waimiadiancan/upload/1616677176001.jpg','<p>11111老好吃了</p>',NULL),(2,2,'20.00','http://localhost:8080/waimiadiancan/upload/1616677163192.jpg','<p>也挺好吃</p>',NULL),(5,1,'10.00','http://localhost:8080/waimiadiancan/upload/1615266843278.jpg','<p>非常好吃</p>',NULL),(7,5,'100.00','http://localhost:8080/waimiadiancan/upload/1616677131810.jpg','<p>1232132</p>',NULL),(8,6,'50.00','http://localhost:8080/waimiadiancan/upload/1616749602736.jpg','<p>推荐</p>',0),(9,7,'9113.00','http://localhost:8080/waimiadiancan/upload/1618539037995.jpg','<p>123</p>',0);
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1618539235836 DEFAULT CHARSET=utf8 COMMENT='购物车表';
...
insert  into `config`(`id`,`name`,`value`) values (1,'picture1','http://localhost:8080/waimiadiancan/upload/1616724528763.jpg'),(2,'picture2','http://localhost:8080/waimiadiancan/upload/1616724552478.jpg'),(3,'picture3','http://localhost:8080/waimiadiancan/upload/1616724633152.jpg'),(4,'picture4','http://localhost:8080/waimiadiancan/upload/1616724648906.jpg'),(5,'picture5','http://localhost:8080/waimiadiancan/upload/1616724660864.jpg');
...
insert  into `liushui`(`id`,`odd`,`cz_types`,`yh_types`,`sf_types`,`maxMoney`,`create_time`) values (18,'1616743554501',4,1,1,'500.00','2021-03-26 15:25:55'),(19,'1616750385629',4,1,1,'300.00','2021-03-26 17:19:46');
...
insert  into `news`(`id`,`addtime`,`title`,`introduction`,`picture`,`content`) values (111,'2021-01-25 11:42:19','标题1','简介1','http://localhost:8080/waimiadiancan/upload/1616724341543.jpg','<p><span style=\"color: rgb(96, 98, 102);\">内容1</span></p>'),(112,'2021-01-25 11:42:19','标题2','简介2','http://localhost:8080/waimiadiancan/upload/1616724431102.jpg','<p>内容2</p>'),(113,'2021-01-25 11:42:19','标题3','简介3','http://localhost:8080/waimiadiancan/upload/1616724461130.jpg','<p>内容3</p>'),(114,'2021-01-25 11:42:19','标题4','简介4','http://localhost:8080/waimiadiancan/upload/1616724473592.jpg','<p>内容4</p>');
...
) ENGINE=InnoDB AUTO_INCREMENT=1618539252243 DEFAULT CHARSET=utf8 COMMENT='订单';

/*Data for the table `orders` */

insert  into `orders`(`id`,`addtime`,`orderid`,`tablename`,`userid`,`goodid`,`goodname`,`picture`,`buynumber`,`price`,`discountprice`,`total`,`discounttotal`,`type`,`status`,`address`) values (1616746637192,'2021-03-26 16:17:16','202132616171687076795','caipin',1,7,'菜品4','http://localhost:8080/waimiadiancan/upload/1616677131810.jpg',4,100,100,400,400,1,'已完成','宇宙银河系金星1号'),(1616750204382,'2021-03-26 17:16:44','202132617164424149237','caipin',1,5,'菜品1','http://localhost:8080/waimiadiancan/upload/1615266843278.jpg',1,10,10,180,10,1,'已退款','宇宙银河系金星1号'),(1616750204831,'2021-03-26 17:16:44','202132617164424984669','caipin',1,8,'菜品5','http://localhost:8080/waimiadiancan/upload/1616749602736.jpg',1,50,50,180,50,1,'已完成','宇宙银河系金星1号'),(1616750205201,'2021-03-26 17:16:44','202132617164424692318','caipin',1,2,'菜品2','http://localhost:8080/waimiadiancan/upload/1616677163192.jpg',6,20,20,180,120,1,'已完成','宇宙银河系金星1号'),(1617269596639,'2021-04-01 17:33:16','20214117331635145217','caipin',1,1,'菜品3','http://localhost:8080/waimiadiancan/upload/1616677176001.jpg',1,30,30,30,30,1,'已派送','宇宙银河系金星1号'),(1618539114695,'2021-04-16 10:11:53','202141610115382297072','caipin',1,1,'菜品3','http://localhost:8080/waimiadiancan/upload/1616677176001.jpg',1,30,30,30,30,1,'已支付','宇宙银河系金星1号'),(1618539240289,'2021-04-16 10:13:59','202141610135962846414','caipin',1,9,'菜品6','http://localhost:8080/waimiadiancan/upload/1618539037995.jpg',1,9113,9113,9113,9113,1,'已完成','宇宙银河系金星1号'),(1618539252242,'2021-04-16 10:14:11','202141610141125300945','caipin',1,9,'菜品6','http://localhost:8080/waimiadiancan/upload/1618539037995.jpg',1,9113,9113,9113,9113,1,'已完成','宇宙银河系金星1号');
...
CREATE TABLE `storeup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1618539048534 DEFAULT CHARSET=utf8 COMMENT='收藏表';

/*Data for the table `storeup` */

insert  into `storeup`(`id`,`addtime`,`userid`,`refid`,`tablename`,`name`,`picture`) values (1618539048533,'2021-04-16 10:10:48',1,9,'caipin','菜品6','http://localhost:8080/waimiadiancan/upload/1618539037995.jpg');
...
insert  into `token`(`id`,`userid`,`username`,`tablename`,`role`,`token`,`addtime`,`expiratedtime`) values (5,1,'admin','users','管理员','o78qqbhkoyhip05oxk7tuj2rgbkchape','2021-03-04 11:02:31','2021-04-16 11:14:24'),(6,1,'111','users','用户','iwdc24jk3dk1bjd3dk2le1zv9jepxbs8','2021-03-13 19:35:22','2021-04-16 11:14:39');
...
insert  into `yonghu`(`id`,`name`,`username`,`password`,`img_photo`,`sex_types`,`phone`,`role`) values (1,'小金','111','111','http://localhost:8080/waimiadiancan/upload/1615259583314.jpg',1,'17796312333','用户'),(2,'小札','222','222','http://localhost:8080/waimiadiancan/upload/1615259866641.jpg',2,'12312312333','用户');
